...
//rules
double opMove(vector<VM*>*  VMs, vector<Job*> jobs, bool checkcost, bool estimate, bool time);//rules to do move operation, returns the cost saved by it
double opSplit(vector<VM*>*  VMs, vector<Job*> jobs, bool checkcost, bool estimate, bool time);
double opMerge(vector<VM*>*  VMs, vector<Job*> jobs, bool checkcost, bool estimate, bool time);
double opPromote(vector<VM*>*  VMs, vector<Job*> jobs, bool checkcost, bool estimate, bool time);
double opDemote(vector<VM*>*  VMs, vector<Job*> jobs, bool checkcost, bool estimate, bool time);
double opCoschedule(vector<VM*>*  VMs, vector<Job*> jobs, bool checkcost, bool estimate, bool time);
